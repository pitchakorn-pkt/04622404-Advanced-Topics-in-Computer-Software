...
TOTAL_BUDGET = 70.0   # ตัวเลขนี้มาจาก CONTRACT ข้อ 0 ไม่ใช่ค่าที่ตั้งเองได้ จึงไม่อ่านจาก env
...
# คำที่บอกว่าผู้ใช้ขอ "สรุป" — ใช้คู่กับ "มีไฟล์แนบมาหรือไม่" เท่านั้น
# ย้ำ: ใช้แค่ "มีไฟล์ไหม" ซึ่งเป็นข้อมูลจาก api ไม่ใช่เนื้อหาในไฟล์ เนื้อหาในไฟล์ห้ามมีผลกับการเลือก route
