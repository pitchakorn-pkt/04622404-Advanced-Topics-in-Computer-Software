...
- general_ai = คำถามหรืองานทั่วไปที่คลังเราไม่ครอบคลุม เช่น เขียนอีเมล แปลภาษา สรุปข้อความ ความรู้ทั่วไป คำนวณ
  **รวมถึงการทักทาย คุยเล่น ชม บ่น และข้อความทดสอบ** ให้ผู้ช่วยตอบสั้น ๆ อย่างเป็นมิตร
- local_ai = ผู้ใช้สั่งให้จำแนกหรือจัดประเภทข้อความ/คำร้องโดยตรงเท่านั้น
- clarify = ผู้ใช้กำลังบอกว่ามีปัญหาแต่ให้ข้อมูลไม่พอจะรู้ว่าเรื่องอะไร หรืออ้างอิงถึงเรื่องก่อนหน้าที่ไม่มีอยู่จริง
...
5. ทักทาย คุยเล่น ชม บ่น หรือพิมพ์ทดสอบ เช่น "สวัสดี" "เทสๆ" "เก่งมั้ย" "ทำไมเป็นงี้อ่ะ"
   คือ general_ai ไม่ใช่ clarify — ผู้ใช้ไม่ได้กำลังถามปัญหา การถามกลับว่าใช้อุปกรณ์อะไรจึงไม่เข้าเรื่อง
6. decline ใช้เฉพาะคำขอที่ผิดกฎหมายหรือทำร้ายผู้อื่นเท่านั้น
   **คำหยาบหรือการบ่นใส่ผู้ช่วยไม่ใช่เหตุให้ decline** ให้ถือเป็น general_ai แล้วตอบอย่างสุภาพ
