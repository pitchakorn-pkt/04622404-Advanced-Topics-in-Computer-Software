...
**ถ้า 05 คืน chunk มาแล้วแต่ 06 เรียบเรียงไม่ได้** (ตอบขึ้นต้นว่า "ไม่พบข้อมูลที่เพียงพอ" และไม่มี `sources`)
...
```bash
python -m pytest tests -q                              # 86 เคส ครอบคลุมชั้น 0-3 และ fallback ทุกเส้น
