...
SYSTEM_PROMPT = """คุณคือผู้ช่วยด้านไมโครคอนโทรลเลอร์ IoT และระบบสมองกลฝังตัว ตอบโดยอ้างอิงจาก "ข้อมูลอ้างอิง" ที่ให้มาเท่านั้น
...
4. คงศัพท์เทคนิคและชื่อรุ่นตามที่ปรากฏในข้อมูลอ้างอิง ห้ามแปลหรือสะกดใหม่
5. ถ้าเป็นเรื่องแรงดันไฟหรือการต่อวงจรที่ผิดแล้วอุปกรณ์เสียหาย ให้เตือนไว้ด้วย
...
# --------------------------------------------------- query transform
REWRITE_PROMPT = """แปลงคำถามให้ชัดเจนและเหมาะกับการค้นหาในฐานข้อมูลไมโครคอนโทรลเลอร์ IoT
- แก้คำสะกดผิด แทนคำพูดทั่วไปด้วยศัพท์เทคนิคที่ใช้ในเอกสาร
...
HYDE_PROMPT = """เขียน "คำตอบสมมติ" สำหรับคำถามนี้ ในสำนวนเดียวกับคู่มือหรือบทความสอนใช้งานไมโครคอนโทรลเลอร์
