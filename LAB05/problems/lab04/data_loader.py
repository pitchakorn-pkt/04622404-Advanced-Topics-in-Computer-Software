...
# สำเนาที่ LAB05: ไฟล์ข้อมูลยังอยู่ที่ LAB04 เดิม จึงชี้ BASE_DIR กลับไปที่นั่น
_HERE = os.path.dirname(os.path.abspath(__file__))          # LAB05/problems/lab04
_REPO = os.path.dirname(os.path.dirname(os.path.dirname(_HERE)))
BASE_DIR = os.path.join(_REPO, "LAB04")
