...
**สิ่งที่ระบบทำได้ตอนนี้** — ล็อกอิน · ถาม-ตอบต่อเนื่องจำบริบทเดิมได้ · แสดงแหล่งอ้างอิงใต้คำตอบ · ประวัติแชท · ให้ feedback 👍👎 · กางดูการตัดสินใจของ agent · สถิติการใช้งาน · ปิดข้อมูลส่วนตัวในคำตอบอัตโนมัติ · สลับผู้ให้บริการ LLM เองเมื่อเจ้าหลักล่มหรือโควตาหมด
