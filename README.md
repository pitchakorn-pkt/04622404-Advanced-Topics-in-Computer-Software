...
| LAB04 | Full RAG system over a Thai IoT/embedded Q&A corpus, with hybrid retrieval, reranking and a measured comparison of Thai-language retrieval settings — see [`LAB04/README.md`](LAB04/README.md) | [`LAB04/`](LAB04/) |
